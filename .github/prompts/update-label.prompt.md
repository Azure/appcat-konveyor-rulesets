...
`- optimize` will point to "cloud-readiness", "containerization", "openjdk11", "openjdk17", "openjdk21", or others like "openjdk", "openjdk8+", etc
...
What I want:
- Check if `- target`, `- os`, `- optimize` are appropriate for the detected issues.
